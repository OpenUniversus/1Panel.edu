// =============================================================================
// 模块: App 应用商店 (agent/app/service/app_upgrade.go)
// 文件: app_upgrade.go — 主代码
...
// appContainerReadinessClient (interface)
